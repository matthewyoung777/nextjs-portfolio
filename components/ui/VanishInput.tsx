    ...
    return (
        ...
        >
            ...
            <input
                ...
                type="text"
                className={cn(
                    "w-full relative text-base z-50 border-none dark:text-[#C1C2D3] bg-transparent text-black h-full rounded-full focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-20",
            ...
            <button
                disabled={!value}
                type="submit"
                className="absolute right-2 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full disabled:bg-gray-100 bg-black dark:bg-[#472f6d88] dark:disabled:bg-[#10132E] transition duration-200 flex items-center justify-center"
            >
                <motion.svg
