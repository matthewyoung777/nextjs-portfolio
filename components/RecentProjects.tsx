    ...
    return (
        <div className="py-20" id="projects">
            ...
            <div className="flex flex-wrap items-center justify-center p-4 gap-x-16 gap-y-8 mt-10">
                {projects.map((item) => (
                    <div
                        className="sm:h-[41rem] h-[25rem] sm:w-[570px] lg:min-h-[32.5rem]  flex items-center justify-center sm:w-96 w-[80vw] lg:mt-20"
                        key={item.id}
                    >
                        <PinContainer title={item.link} href={item.link}>
                            <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden h-[20vh] lg:h-[30vh] mb-10 sm:h-[40vh]">
                                ...
                                <img
                                    src={item.img}
                                    alt="cover"
                                    className={`z-10 absolute ${item.imgClassName || "bottom-0"}`}
                                    width={530}
                                    height={530}
                                />
                            </div>
